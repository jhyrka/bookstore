...
function App() {
  ...
  const fetchBooks = () => {
    fetch(
      "https://bookstore-6f480-default-rtdb.europe-west1.firebasedatabase.app/books/.json"
    )
  ...
  const deleteBook = (id) => {
    fetch(
      `https://bookstore-6f480-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
      {
        method: "DELETE",
      }
    )
